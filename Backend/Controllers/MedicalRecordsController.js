...
return res.status(200).json({message: "added successfully", addNewMedicalRecords})
...
try {
      ...
      const foundPatient = await medicalRecords.findOne({ id_Number: `${id_Number}` });
...
module.exports = { createMedicalRecords, getPatientsMedicalRecords,getSinglePatientsRecord };
